 ...
 * * @param additionalOffset - Additional pixel offset to account for fixed headers or navbars (default: 128px).
 */
export function initScrollSpy(additionalOffset: number = 128): void {
